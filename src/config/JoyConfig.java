...
public class JoyConfig {
	...
	public static final int shooterStartButton = 1;
	public static final int shooterStopButton = 3;
	public static final int generatePathButton = 11;
	public static final int followPathButton = 12;
	public static final int climbButton = 9;
	public static final int climbSlowButton = 10;
