...
public class PathConfig {
	...
	public static final double maxVel = 80; // inches/second
	public static final double maxAcc = 80; // (inches/second) / second
	...
	public static final double robotTrackWidth = 31; // Feet between drivebase wheels, from center of wheels
